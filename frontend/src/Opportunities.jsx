...
export default function Opportunities() {
  const usrData = JSON.parse(
    localStorage.getItem("Data") ||
      '{"User":"Login","Age":0,"Username":"Login","Id":-999,"type":"Student"}'
  );
  ...
  const [message, setMessage] = useState(null); // new: message text
  ...
  return (
    <>
      <img
        src={pattern}
        style={{ height: "100vh" }}
        className="absolute hue-rotate-[-250deg] right-0"
      />
      <h1 className="green-txt absolute text-3xl font-black ml-10 mt-5 left-40 top-[16vh]">
        Opportunities
      </h1>
      <div className="absolute left-10 w-2/5 top-[17vh] mt-20 scrollable-container">
        {events.map((obj, key) => (
          <div
            className="notification mb-3 border border-4 border-[--accent]"
              ...
              <div className="success-prompt-wrap">
                ...
                <div className="success-prompt-prompt mb-3 font-bold">
                  <p>
                    ...
                    {events[Index]?.Event_Time.replace("T", " at ")}
                  </p>
                </div>
